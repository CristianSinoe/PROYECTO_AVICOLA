...
@Component({
    ...
    template: ` <div class="card">
            <div class="font-semibold text-xl mb-4">LISTA DE TRABAJADORES</div>
            <p-table
                #dt1
                [value]="customers1"
                dataKey="id"
            ...
            >
                        ...
                        <!-- <th style="min-width: 12rem">
                            <div class="flex justify-between items-center">
                                ...
                                <p-columnFilter field="status" matchMode="equals" display="menu">
                                    <ng-template #filter let-value let-filter="filterCallback">
                                        <p-select [ngModel]="value" [options]="statuses" (onChange)="filter($event.value)" placeholder="ESTATUS" [style]="{ 'min-width': '12rem' }">
                                            <ng-template let-option #item>
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="8">NO HAY TRABAJADORES</td>
                    </tr>
                </ng-template>
                <ng-template #loadingbody>
                    <tr>
                        <td colspan="8">CARGANDO TRABAJADORES, ESPERE UN MOMENTO POR FAVOR</td>
                    </tr>
                </ng-template>
            </p-table>
        </div>
...
export class TableDemo implements OnInit {
    ...
    ngOnInit() {
        ...
        this.statuses = [
            ...
            { label: 'NEGOCIACION', value: 'negotiation' },
            { label: 'RENOVACION', value: 'renewal' },
